package ru.ssau.pigeonmail.bottomNav.profile;
...
public class ProfileFragment extends Fragment {
    ...
    ActivityResultLauncher<Intent> picKImageActivityLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(),
            ...
            storage.getReference().child("images/"+uid)
                    .putFile(filePath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            Toast.makeText(getContext(),"Successfully uploaded your photo",Toast.LENGTH_SHORT).show();
                            ...
                            storage.getReference().child("images/"+uid).getDownloadUrl()
                                    .addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            FirebaseDatabase.getInstance("https://pigeonmail-b4695-default-rtdb.europe-west1.firebasedatabase.app/")
                                                    .getReference().child("Users").child(uid).child("profileImage").setValue(uri.toString());
                                        }
                                    });
                        }
                    });
